...
/* 6) a) Create the variable commandOverride, and set it to be true or false. If commandOverride is false, then the shuttle should only launch if the fuel and engine check are OK. If commandOverride is true, 
then the shuttle will launch regardless of the fuel and engine status. */
let commandOverride = false
if (!commandOverride){
    console.log("Launch failure. Check fuel levels and engine temperature.");
} else {
